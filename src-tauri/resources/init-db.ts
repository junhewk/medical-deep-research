#!/usr/bin/env bun
/**
 * Database initialization script for desktop builds (Bun + bun:sqlite)
 *
 * Adapted from web/scripts/init-db.ts — uses bun:sqlite instead of better-sqlite3.
